...
$(document).ready(function () {
  ...
  $('#item-1-mp3').click(function () {
    $('#item-1-mp3').removeClass("old-selected");
    $('#item-1-mp3').children(".item-arrow-grey").hide();
    $('#item-1-mp3').siblings().removeClass("old-selected");
    $('#item-1-mp3').siblings().children(".item-arrow-grey").hide();
    $('.folder-mp3').show();
    $('.folder-mp3').siblings().hide();
    $('.folder-mp3').children().removeClass("selected");
    $('.folder-mp3').children().removeClass("old-selected");
    $('.folder-mp3').children().children(".item-arrow-grey").hide();
    $('.folder-mp3').children().children(".item-arrow-blue").hide();
    $('.folder-mp3').children().children(".item-arrow").show();
  });
  ...
  $('#item-instagram').dblclick(function () {
    window.open('https://instagram.com/milfosh');
  });


  $('#item-2-youtube').dblclick(function () {
    window.open('https://www.youtube.com/channel/UCk5cGML6ODOkMqA4ZVv-__w');
  });


  $('#item-2-discord').dblclick(function () {
    window.open('https://discord.gg/Ffe2PPZNe5');
  });
